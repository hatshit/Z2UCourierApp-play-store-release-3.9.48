...
/**
 * Created by Arun on 17-Apr-2018.
 */
...
public class PinEntryEditText  extends EditText {
    ...
    protected float mSpace = 16; //24 dp by default, space between the lines
    protected float mCharSize;
    protected float mNumChars = 4;
    protected float mTextBottomPadding = 10; //8dp by default, height of the text from our lines
    ...
    protected float mLineStroke = 1.5f; //1dp by default
