package com.zoom2u.userlatlong;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert(){
        try {
            ...
            Dialog enterFieldDialog  = new Dialog(mContext);
            ...
            enterFieldDialogMsg.setText("GPS is not enabled. Do you want to go to settings menu?");
